function MARIE_Solve(angle)
%function MARIE_Solve()
%reproduces the work of MARIE_SolveMR without GUI
...
if ispc 
    filename = strcat('~\Desktop\MARIE-master', SAR.Coil_name);
else
    filename = strcat('~/Desktop/MARIE-master', SAR.Coil_name);
end;

filename = strcat(filename, '_angle_');
