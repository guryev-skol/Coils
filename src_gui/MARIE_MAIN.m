...
% Last Modified by GUIDE v2.5 28-Sep-2015 11:39:37
...
global SAR;  % update coil parameters 
...
% --- Executes on button press in rotate_coils.
function rotate_coils_Callback(hObject, eventdata, handles)
% hObject    handle to rotate_coils (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
x = get(handles.alpha_x, 'value');
y = get(handles.alpha_y, 'value');
z = get(handles.alpha_z, 'value');
...
if (isnan(x) | isnan(y) | isnan(z))
    ...
    disp('Angles should be in Deg.! Try again!');
else
    x = deg2rad(x);
    y = deg2rad(y);
    z = deg2rad(z);
    
    rotate_geometry(x, y, z);
    Refresh_Callback(handles.Refresh, eventdata, handles);
end;



function alpha_x_Callback(hObject, eventdata, handles)
% hObject    handle to alpha_x (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of alpha_x as text
%        str2double(get(hObject,'String')) returns contents of alpha_x as a double

a_x = str2double(get(hObject,'String'));
set(hObject,'value', a_x);
%disp(a_x)


% --- Executes during object creation, after setting all properties.
function alpha_x_CreateFcn(hObject, eventdata, handles)
% hObject    handle to alpha_x (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function alpha_y_Callback(hObject, eventdata, handles)
% hObject    handle to alpha_y (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of alpha_y as text
%        str2double(get(hObject,'String')) returns contents of alpha_y as a double
a_y = str2double(get(hObject,'String'));
set(hObject,'value', a_y);

% --- Executes during object creation, after setting all properties.
function alpha_y_CreateFcn(hObject, eventdata, handles)
% hObject    handle to alpha_y (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function alpha_z_Callback(hObject, eventdata, handles)
% hObject    handle to alpha_z (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of alpha_z as text
%        str2double(get(hObject,'String')) returns contents of alpha_z as a double
a_z = str2double(get(hObject,'String'));
set(hObject,'value', a_z);


% --- Executes during object creation, after setting all properties.
function alpha_z_CreateFcn(hObject, eventdata, handles) 
% hObject    handle to alpha_z (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
